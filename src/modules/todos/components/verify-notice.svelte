...
<div class="flex min-h-[calc(100vh-150px)] items-center justify-center px-2 py-8 sm:px-4 sm:py-12 md:px-6 lg:px-8">
	<div class="w-full max-w-sm rounded-2xl bg-white p-4 shadow-lg ring-1 ring-indigo-100 sm:max-w-md sm:p-8 lg:rounded-3xl lg:shadow-xl">
		<div class="flex flex-col items-center">
			...
			<h2 class="mb-2 text-xl font-bold text-indigo-700 sm:text-2xl">Verifikasi Email Diperlukan</h2>
			...
			<Button variant="primary" onClick={handleResend} disabled={loading} className="w-full sm:w-auto">
				{#if loading}
